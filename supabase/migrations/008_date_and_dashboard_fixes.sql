-- ============================================================
-- ROLLY - Date Handling and Processing Fixes
-- Run after 001 through 007 and rls_policy.sql
-- ============================================================
...
begin
    ...
    for scheduled_payment in
        ...
        where household_id = current_household_id
          and status = 'pending'
          and scheduled_date <= effective_today
...
grant execute on function public.current_app_date() to authenticated;
